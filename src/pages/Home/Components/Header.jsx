...
function Header() {
  return (
    <>
      ...
      <div
        id="search__bar"
        className="flex items-center m-5 rounded border rounded-[20px] border-2 border-amber-800"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
          fill="currentColor"
          className="bi bi-search bg-amber-600 p-2 cursor-pointer rounded-l-[20px] h-10 w-10"
          viewBox="0 0 16 16"
        >
