...
function Offers() {
  ...
  return (
    <section id="offers" className="h-fit pb-7 my-4 items-center">
      ...
      >
        <SwiperSlide className="border w-fit h-fit border-2 border-gray-600 shadow-xl shdaow-black">
          <div>
            <img src="https://fakeimg.pl/300/" alt="jewel image" className="" />
        ...
        <SwiperSlide className="border w-fit h-fit border-2 border-gray-600">
          <div>
            <img src="https://fakeimg.pl/300/" alt="jewel image" className="" />
            <div className="flex flex-col">
              <span>گوشوارهK137</span>
